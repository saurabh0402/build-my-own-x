...
eval("function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _iterableToArrayLimit(arr, i) { var _i = arr && (typeof Symbol !== \"undefined\" && arr[Symbol.iterator] || arr[\"@@iterator\"]); if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\nvar reflex = __webpack_require__(/*! ../../reflex */ \"../reflex/index.js\");\n/** @jsx reflex.createElement */\n\n\nvar App = function App() {\n  var _reflex$useState = reflex.useState(1),\n      _reflex$useState2 = _slicedToArray(_reflex$useState, 2),\n      state = _reflex$useState2[0],\n      setState = _reflex$useState2[1];\n\n  return reflex.createElement(\"div\", null, reflex.createElement(\"h1\", {\n    className: \"hello\",\n    onClick: function onClick() {\n      return setState(function (s) {\n        return s + 1;\n      });\n    }\n  }, state), reflex.createElement(\"h2\", null, \" Hello, there. Click count to increase it. \"));\n};\n\nvar container = document.getElementById('root');\nreflex.render(reflex.createElement(App, null), container);\n\n//# sourceURL=webpack://reflex-example/./src/index.jsx?");
